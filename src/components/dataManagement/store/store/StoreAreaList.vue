            ...
            <el-table border style="width: 100%;" :data="form.tableData">
                <el-table-column  label="库区名称"  align="center" :show-overflow-tooltip="true">
                    <template slot-scope="sp">
                        <el-form-item  :prop="'tableData.'+sp.$index+'.storeAreaName'" :rules="[{ validator:validatePass, message: '请输入', trigger: 'blur' }]"  v-if="sp.$index==cIndex"><el-input size="mini" v-model="sp.row.storeAreaName"></el-input></el-form-item>
