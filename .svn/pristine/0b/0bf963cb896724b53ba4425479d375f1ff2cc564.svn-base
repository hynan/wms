      ...
      <div class="right-content-body">
        ...
        <div style="padding: 5px">
          ...
          <el-table :data="detailList" border style="width: 100%"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="stockInAmount" label="入库数量" min-width="150" align="center" :show-overflow-tooltip="true">
            ...
            <el-table-column prop="inventoryProfitAmount" label="盘盈数量" align="center" :show-overflow-tooltip="true" >
            </el-table-column>
          ...
          <div style="text-align: right;padding: 7px;">
            <!--<el-button size="mini" :disabled="uploading" @click="submit('saveInventoryProfit')">保存</el-button>-->
            <el-button size="mini" :disabled="uploading" type="primary" @click="submit('subInventoryProfit')">提交</el-button>
          </div>
        </div>
      </div>
    </div>
  ...
  export default{
    ...
    methods:{
        ...
        doAjax(){
            ...
            this.$http.post('/ys-web-wms/check/getINList', {id: this.$route.params.id}).then(
                (res) => {
